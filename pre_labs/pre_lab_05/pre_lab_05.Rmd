...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer** It takes the Maryland row and turns its data into a header row. 
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer** The columns are still unclear/unlabeled, and the county names have space-filling dots after them that will mess with data standardization.
