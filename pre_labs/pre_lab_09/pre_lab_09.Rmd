...
https://www.datawrapper.de/_/BUiYp/ 
...
md_gov_county <- md_gov_county |>
  clean_names() |>
  rename(Cox = cox, Moore = moore, Lashar = lashar, Wallace = wallace, Harding = harding, Write_ins = write_ins) |>
...
Now, the map is zoomed into just Maryland, with the option of further obscuring those West Virginia, Virginia, Pennsylvania and Delaware counties that surround the state. 
...
Now, when you hover your cursor over a county, that county's name appears with a clear percentage of Moore's vote within the jurisdiction.
...
https://www.datawrapper.de/_/Ej8vg/ 